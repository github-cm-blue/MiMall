<template>
  <div class="product" v-if="isLoad">
    <product-param :title="product.product.productName">
      <template v-slot:buy>
    ...
    <div class="content">
      <div class="item-bg">
        ...
        <h3>{{product.product.productIntro}}</h3>
        <p>
        ...
        <div class="price">
          <span>
            ￥
            <em>{{product.product.productPrice}}</em>
          </span>
        </div>
      </div>
      ...
      <div class="item-swiper">
        ...
        <p class="desc">{{product.product.productName}}} AI变焦双摄拍摄</p>
      </div>
